...
global.channelLink = "https://whatsapp.com/channel/0029Vb6WJ1IL2AU658NaxT2Q";
global.ytch = "Sყɾҽɳƚԋα";
    ...
    try {
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.mode'):
                ...
                if (!message.key.fromMe && !senderIsSudo) {
                    await sock.sendMessage(chatId, { text: 'Only bot owner 𝓕𝓪𝓲𝔃𝓪𝓷 can use this command!', ...channelInfo });
                    return;
                }
            ...
            case userMessage.startsWith('.antilink'):
                ...
                if (!isBotAdmin) {
                    await sock.sendMessage(chatId, {
                        text: 'Please make the 𝓕𝓪𝓲𝔃𝓪𝓷 bot an admin first.',
                        ...channelInfo
                    });
                    return;
                }
            ...
            case userMessage.startsWith('.chatbot'):
                ...
                if (!chatbotAdminStatus.isSenderAdmin && !message.key.fromMe) {
                    await sock.sendMessage(chatId, { text: '*Only admins or bot owner 𝓕𝓪𝓲𝔃𝓪𝓷 can use this command*', ...channelInfo });
                    return;
                }
